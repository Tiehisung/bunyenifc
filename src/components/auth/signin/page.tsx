...
const LoginPage = () => {
  ...
  const [user, setUser] = useState<ISession["user"] | null>(null);
  ...
  // Check for existing session/user in localStorage or your auth context
  useEffect(() => {
    // Replace this with your actual auth check (context, localStorage, etc.)
